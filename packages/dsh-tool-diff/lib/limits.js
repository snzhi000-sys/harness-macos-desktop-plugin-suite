...
/** 校验输入字节数；超限抛 diff: 错误。 */
export function assertInputSize(text, label) {
...
export function normalizeMaxChanges(maxChanges) {
