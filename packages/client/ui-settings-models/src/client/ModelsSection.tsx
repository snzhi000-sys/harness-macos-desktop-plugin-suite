...
export type ModelsSectionProps = Partial<ModelsSectionInjected> & Partial<PropsRenderSlots<ModelsChildSlots>>
...
/** Whether the page has confirmed the provider row's referenced key. */
...
function Loaded({ injected, renderSlot }: { injected: ModelsSectionInjected; renderSlot: ModelsRenderSlot }): ReactNode {
