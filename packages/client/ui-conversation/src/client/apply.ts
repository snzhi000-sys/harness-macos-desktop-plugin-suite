...
import { ConversationViewActivation } from './view-activation.ts'
...
export function apply(ctx: Context): void {
  ...
  const viewActivation = new ConversationViewActivation()
  ...
  slots.register({
    ...
    inject: (sessionId: SessionId | undefined): ConversationInjected => ({
      hooks: {
        ...
        activeView: sessionId === undefined ? CHAT_VIEW : viewActivation.storeFor(sessionId),
      },
  ...
  ctx.plugin(ConversationController, { input: inputHub, blocks: composerBlocks, viewActivation })
