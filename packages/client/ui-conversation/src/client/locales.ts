...
export const zh = {
  ...
  'access.confirm.description': 'Full access 允许 AI 读取和修改任意路径，并关闭权限审批提示；AI 产生的本地文件修改仍会进入可恢复审核。仅建议在你信任当前任务时使用。',
...
export const en = {
  ...
  'access.confirm.description': 'Full access lets the AI read and modify any path without permission prompts; recoverable review remains enabled for local file changes. Use it only when you trust the current task.',
