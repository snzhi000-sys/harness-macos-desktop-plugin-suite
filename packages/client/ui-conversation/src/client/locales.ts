...
export const zh = {
  ...
  'access.confirm.description': 'Full access 允许 AI 在系统权限范围内读取和修改任意路径，并关闭权限审批提示；Shell 审核可能不完整，未记录的修改可能无法恢复。仅建议在你信任当前任务时使用。',
  ...
  'chat.retryOlder': '加载失败，重试',
  'chat.historyStart': '已到最早的记录',
  'chat.turnNavigation.label': '回合导航',
  ...
  'message.turnErrorRecovered': '此前运行失败，后续已恢复',
...
export const en = {
  ...
  'access.confirm.description': 'Full access lets the AI read and modify any path allowed by the OS without permission prompts; Shell review may be incomplete and unrecorded changes may be unrecoverable. Use it only when you trust the current task.',
  ...
  'chat.retryOlder': 'Loading failed. Retry',
  ...
  'message.turnErrorRecovered': 'An earlier turn failed; a later answer recovered',
