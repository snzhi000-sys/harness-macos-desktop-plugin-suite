...
function scanClassEnd(pattern, j) {
...
function scanParenEnd(pattern, i) {
    let depth = 1;
    let j = i;
    while (j < pattern.length) {
        const c = pattern[j];
    ...
    while (i < len) {
        ...
        if (ch === '(') {
            ...
            if (pattern[j] === '?') {
                ...
                if (c2 === ':') {
                    kind = 'Non-capturing group';
                    j += 2;
                }
                else if (c2 === '=') {
                    kind = 'Lookahead (positive assertion)';
                    j += 2;
                }
                else if (c2 === '!') {
                    ...
                    if (c3 === '=') {
                        kind = 'Lookbehind (positive assertion)';
                        j += 3;
                    }
                    else if (c3 === '!') {
