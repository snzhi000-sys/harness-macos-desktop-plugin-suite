/**
 * Package-owned invariant companion for `dsh-workspace-lineage`.
 * @module dsh-workspace-lineage/invariant
 */
...
const PACKAGE_NAME = 'dsh-workspace-lineage'

/** Cordis companion plugin name. */
export const name = 'workspace-lineage-invariant'
