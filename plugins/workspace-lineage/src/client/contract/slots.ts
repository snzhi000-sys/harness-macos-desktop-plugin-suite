...
// This fork replaces the stock Workspace browser package from outside the
// Harness monorepo, so it repeats the sidebar owner's tiny public contract
// rather than resolving a second physical copy of ui-slots through a source
// workspace symlink.
...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    /** Sidebar shell seat filled by this Workspace browser replacement. */
