...
export declare const MAX_DATA_BYTES: number;
...
export declare const MAX_SCHEMA_NODES = 10000;
/** 最大 instance 遍历节点数（验证过程中的访问次数，含组合分支重访）。 */
export declare const MAX_INSTANCE_NODES = 100000;
/** 默认/最大错误数。 */
export declare const DEFAULT_MAX_ERRORS = 100;
export declare const MAX_ERRORS = 1000;
/** 组合关键字（anyOf/oneOf/not）单分支摘要最多保留的错误数。 */
export declare const MAX_BRANCH_ERRORS = 3;
/** 最大 `$ref` 链长。 */
export declare const MAX_REF_CHAIN = 64;
/** 最大 pattern 数（每个 schema）。 */
export declare const MAX_PATTERNS = 100;
/** 单 pattern 长度上限（字节，UTF-8）。 */
export declare const MAX_PATTERN_BYTES: number;
/** pattern 验证总硬预算（ms）；到期 worker.terminate()。 */
export declare const PATTERN_BUDGET_MS = 1000;
/** 工具 timeoutMs。 */
export declare const TOOL_TIMEOUT_MS = 3000;
...
export declare const MULTIPLE_OF_TOLERANCE = 1e-9;
